...
/**
 * Вызов модуля
 * @param {String} id - индентификатор модуля
 * @param {Object|Array|String|Number} data - данные для отрисовки
 * @param {String} [mode] - мода для поиска шаблонов в ней
 * @param {Array} [args] - параметры вызова шаблона
 * @param {String} [nodeName] - имя для корневой ноды
 * @returns {*}
 */
