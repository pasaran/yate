...
yr.run = function(id, data, mode) {
    ...
    var r = module.a(module, [ root ], mode, { attrs: {} } );
...
yr.simpleJPath = function simpleJPath(name, context) {
...
//  NOTE: ex applyValue.
Module.prototype.a = function applyValue(M, nodeset, mode, a0, _) {
    var r = '';
...
yr.selectNametest = function(step, context, result) {
...
//
//  NOTE: ex funcs
Module.prototype.f = function funcs(id, c0, i0, l0, v0, _) {
