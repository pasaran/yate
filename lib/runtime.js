...
Module.prototype.matched = function matched(jpath, c0, i0, l0) {
    if (jpath === null) {
        //  Это jpath '/'
        return !c0.parent;
    }
...
Module.prototype.vars = function vars(name, c0) {
    ...
    if (value === undefined) {
        var var_ = this.findSymbol(name);
        value = this._vars[name] = var_(this, c0, 0, 1);
    }
    return value;
};

Module.prototype.funcs = function funcs(name, c0, i0, l0, v0, _) {
    var func = this.findSymbol(name);
