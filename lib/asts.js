...
var InputStream = require('parse-tools/inputstream.js');
...
yate.asts.module.deinclude = function() {
    ...
    this.p.Block.p.Imports.iterate(function(item) {
        ...
        var input = new InputStream(module.filename);
...
yate.asts.apply.closes = common.false;
...
yate.asts.attr.closes = common.false;
...
yate.asts.inline_expr.inline = common.true;
...
yate.asts.inline_number.isLocal = common.false;

yate.asts.inline_number.isConst = common.true;
...
yate.asts.string_literal.isConst = common.true;

yate.asts.string_literal.isLocal = common.false;
...
yate.asts.inline_var.isLocal = common.false;
...
yate.asts.arglist_item.isConst = common.false;
