...
asts.block_exprs.w_prepare = function() {
    ...
    if ( this.getType() !== 'xml' && this.as_type !== 'xml' ) { return; }
...
asts.inline_expr.w_transform = function() {
    ...
    if ( this.isSimple() && (!as_type || as_type === 'scalar' || as_type === 'boolean') ) {
        return this;
    }

    if ( as_type && needCast( this.getType(), as_type ) ) {
