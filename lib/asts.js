...
asts.jpath_predicate.isMatchable = function() {
    return this.Expr.isLocal() || this.Expr.type() === 'boolean';
};

asts.jpath_predicate.setTypes = function() {
    if (this.isLocal() || this.Expr.type() === 'boolean') { // .items[ .count ] -- Expr является значением, зависящим от контекста. Это предикат.
