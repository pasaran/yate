...
/*
yate.asts.block.action = function() {
    /// this.Exprs.AsList = this.AsList;

    //  FIXME: Это вроде и не нужно, оно есть в inline().
    if ( this.p.Imports.empty() && this.p.Defs.empty() && this.p.Templates.empty() && this.p.Exprs.inline() ) {
        this.f.Inline = true;
    }
};
*/
