...
yate.asts.if_._getType = function() {
    ...
    this.p.Elses.iterate(function(item) {
        type = yate.types.commonType( type, item.type() );
    });
    return type;
};
...
yate.asts.attrs_close._type = 'xml';
...
yate.asts.attrs_open._type = 'xml';
...
yate.asts.inline_number._type = 'scalar';
...
yate.asts.inline_string._type = 'scalar';
...
yate.asts.string_content._type = 'scalar';
...
yate.asts.string_literal._type = 'scalar';
...
yate.asts.inline_internal_function.findSignature = function(callargs) {
    ...
    function checkArgs(args, callargs) {
        for (var i = 0, l = callargs.length; i < l; i++) {
            ...
            if ( !arg || !yate.types.convertable( callarg.type(), arg ) ) {
                return false;
            }
        }
...
yate.asts.jpath_predicate.setTypes = function() {
    if (this.isLocal() || this.p.Expr.type() === 'boolean') {
...
yate.asts.jpath_filter._type = 'nodeset',
...
yate.asts.callarg.type = function() {
    return this.p.Expr.type();
};
