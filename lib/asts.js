...
yate.asts.body.w_list = function() {
    this.p.Block.f.AsList = this.f.AsList;
};
...
yate.asts.block.w_list = function() {
    if (this.f.AsList) {
...
yate.asts.if_.w_list = function() {
    if (this.f.AsList) {
        this.p.Then.f.AsList = true;
        this.p.Elses.iterate(function(item) {
            item.p.Body.f.AsList = true;
        });
    }
};
...
yate.asts.for_.w_list = function() {
    this.p.Body.f.AsList = this.f.AsList;
};
...
yate.asts.array.w_list = function() {
    this.p.Block.f.AsList = true;
};

yate.asts.cdata = {};

yate.asts.cdata._getType = pt.common.retv('xml');
