...
yate.asts.items.applyChildren = function(callback, params) {
    var items = this.p.Items;
    for (var i = 0, l = items.length; i < l; i++) {
...
yate.asts.items.walkAfter = function(callback, params, pKey, pObject) {
    var items = this.p.Items;
    for (var i = 0, l = items.length; i < l; i++) {
...
yate.asts.items.walkBefore = function(callback, params) {
...
yate.asts.items.mergeWith = function(ast) {
    this.p.Items = this.p.Items.concat(ast.p.Items);
};
...
yate.asts.module.deinclude = function() {

    var a = [];
    this.p.Block.p.Imports.iterate(function(item) {
        ...
        var input = new pt.InputStream(module.filename);
    ...
    var Defs = this.p.Block.p.Defs;
    Defs.p.Items = a.concat(Defs.p.Items);
};
...
yate.asts.block._init = function(exprs) {
    var p = this.p;
...
yate.asts.block.deinclude = function() {
    var that = this;
    this.p.Includes.iterate(function(include) {
        var ast = yate.parse(include.p.Filename, 'module');
        ast.walkBefore(function(ast) {
            ast.deinclude();
        });
        that.mergeWith(ast.p.Block);
    });
};
...
yate.asts.block_exprs.validate = function() {
    var opened = [];
    this.iterate(function(item) {
...
yate.asts.block_exprs.prepare = function() {
...
yate.asts.block_exprs.yate__ = function() {
    var exprs = [];
    var indent = 0;
...
yate.asts.template.action = function() {
    this.p.Id = this.state.tid++;
};

yate.asts.template.setTypes = function() {
...
yate.asts.template_selectors.validate = function() {
    this.iterate(function(selector) {
...
yate.asts.var_.action = function() {
...
yate.asts.var_.setTypes = function() {
    this.p.Value.cast();
};

yate.asts.var_.prepare = function() {
...
yate.asts.var_.extractDefs = function() {
...
yate.asts.function_.action = function() {
...
yate.asts.function_.validate = function() {
...
yate.asts.function_.setTypes = function() {
    this.p.Body.cast();
};

yate.asts.function_.extractDefs = function() {
    this.scope.defs.push(this);
};
...
yate.asts.key.validate = function() {
...
yate.asts.key.prepare = function() {
...
yate.asts.key.extractDefs = function() {
    this.scope.defs.push(this);
};
...
yate.asts.external.action = function() {
    var functions = this.scope.functions;
    var name = this.p.Name;
...
yate.asts.external.extractDefs = function() {
    this.scope.defs.push(this);
};
...
yate.asts.if_.setTypes = function() {
...
yate.asts.for_.prepare = function() {
    this.p.Body.cid();
};
...
yate.asts.apply._getType = pt.common.retv('xml');

yate.asts.apply.validate = function() {
    if ( !this.p.Expr.getType('nodeset') ) {
        this.error('Type of expression should be NODESET');
    }
};

yate.asts.apply.closes = pt.common.false;
...
yate.asts.attr._getType = pt.common.retv('attr');

yate.asts.attr.setTypes = function() {
    this.p.Name.cast('scalar');
    this.p.Value.cast('scalar');
};

yate.asts.attr.prepare = function() {
    if ( !this.p.Value.inline() ) {
        this.p.Value.rid();
    }
};

yate.asts.attr.closes = pt.common.false;
...
yate.asts.attrs_close._getType = pt.common.retv('xml');
...
yate.asts.attrs_open._getType = pt.common.retv('xml');
...
yate.asts.xml._getType = pt.common.retv('xml');
...
yate.asts.xml_end.action = function() {
...
yate.asts.xml_attr.prepare = function() {
...
yate.asts.inline_expr.inline = pt.common.true;
...
yate.asts.inline_expr.transform = function() {
    if (this.p.AsType) {
        if ( this.isSimple() && this.p.AsType === 'scalar' ) {
            return this.make( 'simple_jpath', this );
        } else if ( needCast( this.getType(), this.p.AsType ) ) {
...
yate.asts.inline_op.setTypes = function() {
...
yate.asts.inline_eq.setTypes = function() {
...
yate.asts.inline_number.isLocal = pt.common.false;

yate.asts.inline_number.isConst = pt.common.true;

yate.asts.inline_number._getType = pt.common.retv('scalar');
...
yate.asts.inline_string._getType = pt.common.retv('scalar');
...
yate.asts.string_content._getType = pt.common.retv('scalar');
...
yate.asts.string_literal._getType = pt.common.retv('scalar');

yate.asts.string_literal.oncast = function(to) {
    if (to === 'attrvalue') {
        this.p.Value = pt.common.quoteAttr(this.p.Value);
    } else if (to === 'xml') {
        this.p.Value = pt.common.quoteText(this.p.Value);
    }
...
yate.asts.string_literal.isConst = pt.common.true;

yate.asts.string_literal.isLocal = pt.common.false;
...
yate.asts.inline_var.action = function() {
...
yate.asts.inline_var.isLocal = pt.common.false;
...
yate.asts.inline_function.action = function() {
    var name = this.p.Name;
...
yate.asts.inline_function.prepare = function() {
    var def = this.def;
...
yate.asts.sort._getType = pt.common.retv('nodeset');

yate.asts.sort.validate = function() {
    if (this.p.Nodes.getType() !== 'nodeset') {
        this.p.Nodes.error('Type should be nodeset.');
    }
};

yate.asts.sort.prepare = function() {
...
yate.asts.jpath._getType = pt.common.retv('nodeset');
...
yate.asts.jpath.validate = function() {
...
yate.asts.jpath.extractDefs = function() {
...
yate.asts.jpath_dots.action = function() {
...
yate.asts.jpath_predicate.setTypes = function() {
...
yate.asts.jpath_predicate.extractDefs = function() {
...
yate.asts.jpath_filter._getType = pt.common.retv('nodeset');
...
yate.asts.jpath_filter.validate = function() {
    if ( !this.p.Expr.getType('nodeset') ) {
...
yate.asts.simple_jpath._getType = pt.common.retv('nodeset');
...
yate.asts.arglist_item.action = function() {
...
yate.asts.arglist_item.isConst = pt.common.false;
...
yate.asts.arglist_item.prepare = function() {
    if (this.p.Default) {
...
yate.asts.pair._getType = pt.common.retv('pair');

yate.asts.pair.setTypes = function() {
...
yate.asts.array._getType = pt.common.retv('array');

yate.asts.array.action = function() {
...
yate.asts.object._getType = pt.common.retv('object');

yate.asts.object.action = function() {
    this.Block.AsList = true;
};
