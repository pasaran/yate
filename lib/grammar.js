...
grammar.skippers.spaces = function(parser) {
    if ( parser.is_eof() ) {
        return false;
    }
...
grammar.skippers.inline_comments = function(parser) {
...
grammar.skippers.block_comments = function(parser) {
    if ( parser.is_eof() ) { return; }
...
grammar.skippers.html_comments = function(parser) {
    if ( parser.is_eof() ) { return; }
