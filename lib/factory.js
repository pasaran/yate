...
yate.Factory.prototype.make = function(id, pos, params) {
...
yate.Factory.prototype.get = function(id) {
    ...
    if (!ctor) {
        ...
        if (options.props) {
            ...
            if ( !methods.clone ) {
                ctor.prototype.clone = gen_clone(props);
            }
            if ( !methods.apply ) {
