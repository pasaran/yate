...
function compile_rule(id, rule, options) {
    ...
    var save_ast_string = options && options.save_ast_string;
    if (save_ast_string) {
        wrapper = function(parser, params) {
            ...
            ast.ast_string = input.substr(0, parser.x - x);
