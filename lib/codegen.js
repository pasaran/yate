...
//
yate.Codegen.prototype._read_templates = function(filename) {
...
yate.Codegen.prototype.generate = function(id, ast, mode) {
    var key = id + ':' + (mode || '');
...
yate.Codegen.prototype.compile_template = function(template) {
...
yate.Codegen.prototype.compile_line = function(line) {
...
yate.Codegen.prototype.compile_macro = function(path, mode) {
    var key = path + ':' + mode;
...
yate.Codegen.prototype.store_macro = function(key, body) {
    var mid = 'm' + this._mid++;
