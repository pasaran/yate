...
yate.compile = function(filename) {
    ...
    console.time('walk.deinclude');
    ast.walkdo(function(ast) {
        ast.w_deinclude();
    });
    console.timeEnd('walk.deinclude');

    console.time('walk.deimport');
    ast.walkdo(function(ast) {
        ast.w_deimport();
    });
    console.timeEnd('walk.deimport');

    console.time('nop');
    ast.dowalk(function(ast) {});
    console.timeEnd('nop');

    console.time('walk.deitemize');
    ast.dowalk(function(ast) {
        ast.w_deitemize();
    });
    console.timeEnd('walk.deitemize');
