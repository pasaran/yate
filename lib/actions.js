...
yate.compile = function(filename) {
    ...
    //  Раскрываем инклюды и импорты.
    /// console.time('walk.deinclude');
    //
    //  FIXME: Было walkBefore, но ломались функции, определенные в инклюде,
    //  использующие функцию, определенную в импорте.
    //  См. тест:
    //
    //  a.yate:
    //
    ...
    //
    //      func test() {
    //          //  Тут ошибка! Неопределенная функция i18n.
    //          <div>{ i18n('123') }</div>
    //      }
    //
    //  Надо еще поизучать этот вопрос.
    //
