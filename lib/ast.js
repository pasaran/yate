...
AST.prototype.is_simple = no.false;
...
AST.prototype.set_as_list = no.nop;
...
AST.prototype.opens = no.false;

AST.prototype.closes = no.true;

//  ---------------------------------------------------------------------------------------------------------------  //

//  Хождение по дереву.

AST.prototype.w_deinclude = no.nop;

AST.prototype.w_deimport = no.nop;

AST.prototype.w_deitemize = no.nop;
...
AST.prototype.w_list = no.nop;

AST.prototype.w_validate = no.nop;

AST.prototype.w_set_types = no.nop;

AST.prototype.w_extract_defs = no.nop;

AST.prototype.w_prepare = no.nop;

AST.prototype.w_transform = no.nop;

//  ---------------------------------------------------------------------------------------------------------------  //

AST.prototype.set_prev_opened = no.nop;
