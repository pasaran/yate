...
asts.function_.action = function() {
    ...
    this.Type = asts.function_type.USER;
...
asts.inline_function.action = function() {
    ...
    if (def.External) {
        this.External = true;
    } else if (def.Type == AST.function_type.USER) {
        this.Fid = def.Fid;
    } else if (def.Type == AST.function_type.KEY) {
        this.Kid = def.Kid;
    }
};
...
asts.inline_function.prepare = function() {
    ...
    } else if (def.Type == AST.function_type.INTERNAL) {
