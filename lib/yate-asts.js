...
var factory = new Factory(AST, asts);
...
//  FIXME: Плохо, что все это инстанцируется прямо здесь и сразу.
//  Хуже всего, что появляется зависимость от factory.js. Надо ее как-то истребить.
